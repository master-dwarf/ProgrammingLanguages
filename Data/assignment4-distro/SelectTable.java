...
public class SelectTable extends Table {
  ...
  */
  ...
  public Table optimize() {
    if (tab_selecting_on instanceof SelectTable) {
  	    return new SelectTable ( ((SelectTable) tab_selecting_on).tab_selecting_on.optimize(),
  					 select_cond); 
  	}
  	else {
  	    tab_selecting_on = tab_selecting_on.optimize();
  	    return this;
  	}
  }
